...
POSITIONS = [
    ...
    {"name": "Software Developer",
        "description": "Software Developer", "department_id": 3},
    {"name": "Sales Manager", "description": "Sales Manager", "department_id": 4},
    {"name": "Sales Representative",
        "description": "Sales Representative", "department_id": 4},
    {"name": "Operations Manager",
        "description": "Operations Manager", "department_id": 5},
    {"name": "Operations Specialist",
        "description": "Operations Specialist", "department_id": 5},
    {"name": "Marketing Manager", "description": "Marketing Manager", "department_id": 6},
    {"name": "Marketing Specialist",
        "description": "Marketing Specialist", "department_id": 6},
]

# Sample data for employees
EMPLOYEES = [
    {"first_name": "Anh", "last_name": "Nguyen", "position_id": 1,
        "department_id": 1, "email": "anh.nguyen@company.com", "phone": "0901234567"},
    {"first_name": "Binh", "last_name": "Tran", "position_id": 3,
        "department_id": 2, "email": "binh.tran@company.com", "phone": "0912345678"},
    {"first_name": "Cuong", "last_name": "Le", "position_id": 1,
        "department_id": 2, "email": "cuong.le@company.com", "phone": "0923456789"},
    {"first_name": "Duyen", "last_name": "Pham", "position_id": 3,
        "department_id": 2, "email": "duyen.pham@company.com", "phone": "0934567890"},
    {"first_name": "Dat", "last_name": "Hoang", "position_id": 1,
        "department_id": 3, "email": "dat.hoang@company.com", "phone": "0945678901"},
    {"first_name": "Huong", "last_name": "Vu", "position_id": 3,
        "department_id": 3, "email": "huong.vu@company.com", "phone": "0956789012"},
    {"first_name": "Khanh", "last_name": "Tran", "position_id": 1,
        "department_id": 4, "email": "khanh.tran@company.com", "phone": "0967890123"},
    {"first_name": "Linh", "last_name": "Nguyen", "position_id": 3,
        "department_id": 4, "email": "linh.nguyen@company.com", "phone": "0978901234"},
    {"first_name": "Minh", "last_name": "Phan", "position_id": 1,
        "department_id": 5, "email": "minh.phan@company.com", "phone": "0989012345"},
]
...
async def populate_users():
    ...
    hashed_password = bcrypt.hashpw(
        "hr123".encode(), bcrypt.gensalt()).decode()
    await execute_mysql_query(
        "INSERT INTO user (Username, Password, Role) VALUES (%s, %s, %s)",
...
async def populate_employees():
    ...
    for emp in EMPLOYEES:
        ...
        join_date = datetime(current_year - years_ago, 1, 1) + \
            timedelta(days=months_ago*30 + days_ago)

        # Generate random salary based on position (higher for managers)
        base_salary = 15000000 if "Manager" in POSITIONS[emp["position_id"] -
                                                         1]["name"] else 10000000
        ...
        birth_date = datetime(birth_year, random.randint(
